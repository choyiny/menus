...
class MenuV2Schema(Schema):
    ...
    start = fields.Int(
        description="Start time for menu interval in the form of total seconds elapsed",
        example=46500,
    )
    end = fields.Int(
        description="End time for menu interval in the form of total seconds elapsed",
        example=51000,
    )
